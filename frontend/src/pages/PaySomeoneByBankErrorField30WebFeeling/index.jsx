        ...
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-poppins md:gap-5 items-start justify-start max-w-[2380px] mt-2 mx-auto md:px-5 w-full">
            <Img
              ...
              alt="iconbacksquare"
            />
            <div className="bg-white-A700 border-[5px] border-light_blue-900 border-solid flex md:ml-[0] ml-[562px] md:mt-0 mt-[27px] p-[15px] relative rounded-[50px] shadow-bs3 w-[28%] md:w-full">
              <Img
            ...
            <Img
              className="md:flex-1 h-[281px] sm:h-auto mb-3 md:ml-[0] ml-[631px] object-cover rounded-[161px] w-[14%] md:w-full"
          ...
          <div className="flex md:flex-col flex-row font-poppins md:gap-5 items-start justify-start max-w-[2456px] mt-3.5 mx-auto md:px-5 w-full">
            <div className="flex flex-1 flex-col items-start justify-start w-full">
              ...
              <div className="bg-white-A700_01 border border-light_blue-800 border-solid flex flex-col items-center justify-start md:ml-[0] ml-[424px] mt-[29px] p-[22px] sm:px-5 rounded-[30px] shadow-bs5 w-[57%] md:w-full">
                <div className="flex flex-col justify-start mb-[73px] w-[89%] md:w-full">
                  <Img
                    className="h-[179px] md:ml-[0] ml-[517px]"
                  ...
                  <div className="flex flex-col items-center justify-start mt-[29px] w-full">
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                      <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex md:flex-1 flex-row items-center justify-between p-6 sm:px-5 rounded-[30px] w-2/5 md:w-full">
                        <Text
                          className="mb-[9px] ml-11 sm:text-[31px] md:text-[33px] text-[35px] text-black-900"
                          size="txtPoppinsBold35Black900"
                        >
                          Transfer
                        </Text>
                      ...
                      <div className="h-28 relative w-2/5 md:w-full">
                        ...
                        <div className="absolute bg-white-A700 border-2 border-light_blue-900 border-solid flex flex-row h-full inset-[0] items-center justify-between m-auto p-7 sm:px-5 rounded-tl-[30px] rounded-tr-[30px] w-full">
                          <Text
                            className="ml-[27px] mt-0.5 sm:text-[31px] md:text-[33px] text-[35px] text-black-900"
                            size="txtPoppinsBold35Black900"
                          >
                            Pay Someone
                          </Text>
                          <div className="bg-light_blue-900 border-2 border-light_blue-900 border-solid h-[47px] mr-[15px] my-[3px] rounded-[23px] w-[47px]"></div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-white-A700 border border-light_blue-900 border-solid flex flex-row md:gap-10 items-center justify-between mt-[63px] p-[11px] rounded-tl-[10px] rounded-tr-[10px] w-full">
                      <Text
                        className="ml-[47px] sm:text-[31px] md:text-[33px] text-[35px] text-black-900"
                        size="txtPoppinsBold35Black900"
                      >
                        BSB{" "}
                      </Text>
                    ...
                    <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex md:flex-col flex-row gap-[57px] items-center justify-end mt-[77px] p-3.5 rounded-[10px] w-[64%] md:w-full">
                      <Text
